...
// Log Water
exports.logsRouter.post('/water', authenticate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { quantityMl } = req.body;
        const waterLog = yield prisma_1.default.waterLog.create({
...
// Log Sleep
exports.logsRouter.post('/sleep', authenticate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const sleepLog = yield prisma_1.default.sleepLog.create({
...
// Log Exercise
exports.logsRouter.post('/exercise', authenticate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const exerciseLog = yield prisma_1.default.exerciseLog.create({
...
// Log Weight
exports.logsRouter.post('/weight', authenticate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { weightKg } = req.body;
        const weightLog = yield prisma_1.default.weightLog.create({
...
// AI Photo Analysis
exports.logsRouter.post('/meal/analyze-photo', authenticate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const fallbackMock = [
...
// AI Voice Analysis
exports.logsRouter.post('/meal/analyze-voice', authenticate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const fallbackMock = [
...
exports.logsRouter.post('/meal', authenticate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const protein = items.reduce((sum, item) => sum + Number(item.protein), 0);
        const carbs = items.reduce((sum, item) => sum + Number(item.carbs), 0);
        const fat = items.reduce((sum, item) => sum + Number(item.fat), 0);
        const mealLog = yield prisma_1.default.mealLog.create({
            data: {
                userId: req.userId,
                mealType,
                mealTime: new Date(),
        ...
        if (logMethod === 'photo' && photoUrl) {
            yield prisma_1.default.mealImage.create({
                data: { mealId: mealLog.id, imageUrl: photoUrl, aiDetectedFood: items.map((i) => i.name).join(', ') }
            });
        }
        if (logMethod === 'voice' && voiceTranscript) {
            yield prisma_1.default.voiceTranscript.create({
                data: { mealId: mealLog.id, transcript: voiceTranscript, aiFoodSummary: items.map((i) => i.name).join(', ') }
            });
        }
